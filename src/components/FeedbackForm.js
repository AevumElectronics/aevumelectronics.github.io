...
export default function FeedbackForm() {
  ...
  return (
    <div  id="feedback" className='bg-zinc-800 p-5 text-slate-200  py-10 min-h-screen'>
        <h2 className='text-4xl font-bold mt-5 mb-5 text-center'>Leave Some Feedback</h2>

        <form id="survey-form" onSubmit={handleSubmit(onSubmit)}
            className='flex flex-col justify-center gap-y-5 max-w-3xl m-auto w-[90%]
          bg-zinc-700 rounded-md p-4 border-slate-100 border-solid border-2 border-opacity-40'>
            <div className='flex'>
