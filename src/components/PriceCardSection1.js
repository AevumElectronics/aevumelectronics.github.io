...
export default function PricingSection1() {
    return (
        <div id="price" className='min-h-screen bg-zinc-800 text-slate-200 py-10 flex flex-col gap-4 content-center m-auto'>
            ...
            <div id="pricesection" className="flex p-10  items-center gap-10 flex-col md:flex-row">
                <div className="flex-1 w-[90%] text-center bg-zinc-700 rounded-xl shadow-lg p-10 hover:shadow-md hover:shadow-sky-900">
